...
export default function DigitalEnvelope({ settings }) {
  ...
  return (
    <div id="gift" className="space-y-6 py-8 px-4 max-w-xl mx-auto text-espresso-800 animate-fade-in-up">
      <div className="text-center space-y-1">
        ...
        <p className="text-xs text-espresso-700 max-w-xs mx-auto">
          Doa Restu Anda merupakan karunia yang sangat berharga bagi kami. Namun jika Anda ingin memberikan hadiah cashless, dapat melalui rekening berikut:
        </p>
      </div>
